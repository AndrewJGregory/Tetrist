...
class Piece {
  ...
  userMove(e) {
    this.removeCurrentPiece();
    const piece = __WEBPACK_IMPORTED_MODULE_0__util__["e" /* movedUserCollection */](e, this.piece);
    this.piece = piece;
  }
}
...
const movedUserCollection = (e, piece) => {
  ...
  return finalizePiece(collection, shapeId);
***REMOVED***
/* harmony export (immutable) */ exports["e"] = movedUserCollection;
